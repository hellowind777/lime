...
pub(in crate::commands::aster_agent_cmd) fn extend_map_with_harness_fields(
    ...
    for (source_key, target_key) in [
        ...
        ("turn_team_decision", "turn_team_decision"),
        ("turnTeamDecision", "turn_team_decision"),
        ("turn_team_reason", "turn_team_reason"),
        ("turnTeamReason", "turn_team_reason"),
        ("turn_team_blueprint", "turn_team_blueprint"),
        ("turnTeamBlueprint", "turn_team_blueprint"),
